...
function Servers(props:any) {
  ...
  return (
    ...
    {openEditModal && <EditServersModal openEditModal={openEditModal} setOpenEditModal={setOpenEditModal}/>}
    ...
    <StyledChannelsDiv to={props.href}>
      <StyledFlexDiv  direction="column">
        ...
        <StyledFlexDiv >
          <Button variant="outlined" sx={{ ...buttonStyles }} onClick={handleEditModal}>
            Edit
          </Button>
          <Button
            variant="outlined"
            sx={{ ...buttonStyles, background: '#EEEEEE', border: 'none', color: '#212121' }}
          >
            Remove
          </Button>
        </StyledFlexDiv>
