...
import{Button, Checkbox, FormControl, FormControlLabel, FormGroup, InputLabel, OutlinedInput, TextField, Typography} from '@mui/material';
...
function LoginForm(){
   ...
   border-radius= "8px"
    >
        ...
        <Typography variant="h4" color="text.primary" component='h2'>Omnio</Typography>
        </Header>
        <FormControl>
   <TextField
   size="small"
