...
const rows = [
  ...
  createData("Eclair", 262, 16.0, 24, 6.0, IconButton),
  createData("Frozen yoghurt", 159, 6.0, 24, 4.0, IconButton),
  createData("Gingerbread", 356, 16.0, 49, 3.9, IconButton),
  createData("Honeycomb", 408, 3.2, 87, 6.5, IconButton),
  createData("Ice cream sandwich", 237, 9.0, 37, 4.3, IconButton),
  createData("Jelly Bean", 375, 0.0, 94, 0.0, IconButton),
  createData("KitKat", 518, 26.0, 65, 7.0, IconButton),
  createData("Lollipop", 392, 0.2, 98, 0.0, IconButton),
  createData("Marshmallow", 318, 0, 81, 2.0, IconButton),
  createData("Nougat", 360, 19.0, 9, 37.0, IconButton),
  createData("Oreo", 437, 18.0, 63, 4.0, IconButton),
];
